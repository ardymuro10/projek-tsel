        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 my-auto">
                <div class="copyright text-center text-sm text-white text-lg-start">
                    ...
                    made with by
                    <a href="https://t.me/Misa_Reamo" class="font-weight-bold text-white" target="_blank">Ghozy</a>
                    & <a href="https://t.me/adiknyahokage" class="font-weight-bold text-white" target="_blank">Muro</a>
                    for a better web.
                </div>
            </div>
